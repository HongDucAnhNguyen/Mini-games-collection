...
void render_ball(const Ball* ball) {
	...
	SDL_Rect ball_rect = create_ball_rect(ball);
...
void update_players(float delta_time, Player* player1, Player* player2)
{
	...
	SDL_Rect ball_rect = create_ball_rect(&g_ball);
	SDL_Rect player1_rect = create_player_rect(player1);

	SDL_Rect player2_rect = create_player_rect(player2);
...
void render_player(const Player* player)
{
	...
	SDL_Rect player_rect = create_player_rect(player);
